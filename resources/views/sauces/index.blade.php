...
@section('content')
<div class="container">
    <h1 class="text-center mb-4">ALL THE SAUCES</h1>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 shadow-sm border-0 transition" style="width: 350px; margin: auto;">
                <div class="overflow-hidden">
                    <img src="{{ asset($sauce->imageUrl) }}" class="card-img-top" alt="{{ $sauce->name }}" style="height:500px; object-fit: cover; transition: transform 0.3s;">
                </div>
                <div class="card-body text-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-2 mt-3">
                        <a href="{{ route('sauces.show', $sauce->id) }}" class="btn btn-info btn-sm rounded-pill">
